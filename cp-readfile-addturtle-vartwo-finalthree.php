...
$string = '';
$rootcontainer = 'http://investors.ddns.net:8080/marmotta/ldp/waypaver-test-1/';
...
/// replace array elements with the local namespace...
 ...
 $replacementarray = array('purl.org/net' => 'data.thespaceplan.com','data.kasabi.com' => 'investors.ddns.net:8080/marmotta/ldp/waypaver-test-1/');
